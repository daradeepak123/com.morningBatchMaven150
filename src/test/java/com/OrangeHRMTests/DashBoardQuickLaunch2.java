...
public class DashBoardQuickLaunch2 extends GenricMethods{
	...
	{
		WebElement assignLeave=driver.findElement(By.xpath("//span[text()='Dashboard']"));
		clickWebElement(assignLeave, driver);
